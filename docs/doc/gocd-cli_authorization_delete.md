## gocd-cli authorization delete

Command to DELETE the specified authorization configuration present in GoCD [https://api.gocd.org/current/#delete-an-authorization-configuration]

```
gocd-cli authorization delete [flags]
```

### Examples

```
gocd-cli authorization delete helm-images
