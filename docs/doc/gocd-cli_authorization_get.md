## gocd-cli authorization get

Command to GET a authorization configuration with all specified configurations in GoCD [https://api.gocd.org/current/#get-an-authorization-configuration]

```
gocd-cli authorization get [flags]
```

### Examples

```
gocd-cli authorization get ldap -o yaml
```
