## gocd-cli pipeline last-schedule

Command to GET last scheduled time of the pipeline present in GoCD [/pipelineHistory.json?pipelineName=nameOfThePipeline]

```
gocd-cli pipeline last-schedule [flags]
```

### Examples

```
gocd-cli pipeline last-schedule sample-pipeline
```

### Options

```
  -h, --help   help for last-schedule
```
