...
```
gocd-cli environment update gocd_environment_1 --from-file gocd_environment_1.yaml
```

### Options

```
      --create   if a environment by this name doesn't already exist, run create
