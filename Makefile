...
image/scan: mock/publish ## scans image for vulnerabilities
	@docker-compose --project-name trivy -f docker-compose.trivy.yml run --rm trivy image ghcr.io/nikhilsbhat/gocd-cli:latest
