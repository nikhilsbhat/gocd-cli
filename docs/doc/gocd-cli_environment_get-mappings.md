## gocd-cli environment get-mappings

Command to Identify the given environment is part of which config-repo of GoCD

```
gocd-cli environment get-mappings [flags]
```

### Examples

```
gocd-cli environment get-mappings --environment production -o yaml
```

### Options

```
      --environment strings   name of the environment for which mappings to be fetched
