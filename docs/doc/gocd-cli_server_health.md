## gocd-cli server health

Command to monitor if the GoCD server is up and running [https://api.gocd.org/current/#check-server-health]

```
gocd-cli server health [flags]
```
