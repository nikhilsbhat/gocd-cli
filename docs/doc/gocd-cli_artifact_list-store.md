## gocd-cli artifact list-store

Command to LIST all artifact stores present in GoCD [https://api.gocd.org/current/#get-all-artifact-stores]

```
gocd-cli artifact list-store [flags]
```
