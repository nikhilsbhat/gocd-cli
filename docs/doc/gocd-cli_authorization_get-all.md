## gocd-cli authorization get-all

Command to GET all authorization configurations present in GoCD [https://api.gocd.org/current/#get-all-authorization-configurations]

```
gocd-cli authorization get-all [flags]
```
