## gocd-cli pipeline-group delete

Command to DELETE the specified pipeline group from GoCD [https://api.gocd.org/current/#delete-a-pipeline-group]

```
gocd-cli pipeline-group delete [flags]
```

### Examples

```
gocd-cli pipeline-group delete movies
```
