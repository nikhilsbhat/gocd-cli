## gocd-cli authorization create

Command to CREATE the authorization configuration with specified configuration [https://api.gocd.org/current/#create-an-authorization-configuration]

```
gocd-cli authorization create [flags]
```

### Examples

```
gocd-cli authorization create --from-file config-repo.yaml -o yaml
```
