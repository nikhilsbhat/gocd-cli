## gocd-cli pipeline delete

Command to DELETE the specified pipeline from GoCD [https://api.gocd.org/current/#delete-a-pipeline]

```
gocd-cli pipeline delete [flags]
```

### Examples

```
gocd-cli pipeline delete movies
```
