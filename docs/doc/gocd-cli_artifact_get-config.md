## gocd-cli artifact get-config

Command to GET a configured artifact configuration GoCD [https://api.gocd.org/current/#get-artifacts-config]

```
gocd-cli artifact get-config [flags]
```
