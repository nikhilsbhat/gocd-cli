## gocd-cli authorization list

Command to LIST all authorization configurations present in GoCD [https://api.gocd.org/current/#get-all-authorization-configurations]

```
gocd-cli authorization list [flags]
```
