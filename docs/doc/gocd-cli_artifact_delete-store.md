## gocd-cli artifact delete-store

Command to DELETE a specific artifact store present in GoCD [https://api.gocd.org/current/#delete-an-artifact-store]

```
gocd-cli artifact delete-store [flags]
```

### Options

```
  -h, --help   help for delete-store
```
